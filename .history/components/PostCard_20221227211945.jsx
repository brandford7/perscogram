...
const Postcard = () => {
  return (
    <div className="border border-blue-500 bg-red rounded">
      ...
      <section className="commentbox flex p-2">
        <Useravatar />
        <textarea placeholder="Write a comment" className="border border-blue-500 p-1 rounded bg-gray-100 h-10 w-full"></textarea>
      </section>
    </div>
  );
};
